...
class InjectorTest {
    ...
    void testCustomComposer() {
        ...
        assertNotSame(injector.getInstance(SampleB.class), injector.getInstance(SampleB.class));
        assertThrows(ProvisionException.class, () -> injector.getInstance(SampleC.class));
        assertThrows(ProvisionException.class, () -> injector.getInstance(SampleD.class));
    }
    ...
    void testProvidedAndComposedBy() {
        var injector = Injector.create(c -> {
            ...
            c.bind(ProvidedBySample.class);
            c.bind(ComposedBySample.class);
        });
    ...
    void testSingletonScope() throws NoSuchMethodException {
        ...
        var injector = Injector.create(c -> {
            ...
            c.bind(SampleE.class).in(Singleton.class);
            c.bind(SampleExtSingleton.class);
    ...
    @Test
    void testUnsatisfiedConstructor() {
        assertThrows(ConfigurationException.class, () -> Injector.create(c -> c.bind(FullC.class)));
    }
